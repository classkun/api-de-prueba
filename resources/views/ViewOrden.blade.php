                              ...
                              <table class="table table-bordered table-striped" id="table">
                                  <thead class="text-center bg-dark text-white">
                                      ...
                                      <th class="text-white" style="text-align: center;"><strong>Codigo</strong></th>
                                          ...
                                          <th class="text-white" style="text-align: center;"><strong>Comentario</strong></th>
                                          <th class="text-white" style="text-align: center;"><strong>Total</strong></th>
                                          <th class="text-white" style="text-align: center;"><strong>Inpuesto</strong></th>
    ...
    var table = $('#table').DataTable({
                ...
                dataSrc : function (datos) {
                        ...
                        for (i = 0; i < data.length; i++) {
                                ...
                                dataResponse.push({"comentario": data[i].comentario, "id": data[i].id,"total":data[i].total,"impuesto":data[i].impuestos, "estatus": data[i].estatus });
        ...
        columns: [
            ...
            { "data": "impuesto", "defaultContent": "" },
            {
                "render": function (data, type, row) {
                    return `  
                    <div class="text-center" style="display: inline-flex;">
                        <a class="btn btn-info  ver btn-md" href="../../Orden/Edit?`+row.id+`"  ><i class="far fa-edit"style="color: #fafafa;"></i></a>
